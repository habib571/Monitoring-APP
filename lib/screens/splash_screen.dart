        ...
        if (snapshot.connectionState == ConnectionState.done) {
          ...
          if (user != null) {
            Future.delayed(Duration.zero, () async {
              Navigator.pushNamedAndRemoveUntil(context, HomeScreenRoute,
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    "This is a project that connects to hardware devices via Firebase and gets the readings from sensors.",
                    style: kBodyText,
                    textAlign: TextAlign.center,
                  ),
                )
